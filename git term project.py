...
if __name__ == "__main__":
    data_file_path = Path("accounts.pkl")  # Change the file path accordingly
    bank = Bank(data_file_path)
#main
    while True:
        ...
        if choice == '1':
            ...
            phone = int(input("Enter the phone no:+91"))
            ...
            new_phone = input("Enter new account phone no:+91 ")
